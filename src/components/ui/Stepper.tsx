    ...
    return {
                ...
                <>
                    ...
                    >
                        <Button
                            ...
                            className={
                                dataState !== "inactive"
                                    ? "stepper-step-indicator rounded-full text-[12px] sm:text-[14px]"
                                    : "stepper-step-indicator rounded-full border-1 border-muted/70 text-muted text-[12px] sm:text-[14px]"
                            }
                            variant={
                                dataState !== "inactive" ? "default" : "ghost"
                            }
                            size="sm"
                        ...
                        <div
                            className={
                                dataState !== "inactive"
                                    ? "stepper-step-content flex flex-col items-start text-primary"
                                    : "stepper-step-content flex flex-col items-start text-muted"
                            }
                        >
                            {title}
                            {description}
        ...
        StepperControls: ({ children, className, asChild, ...props }) => {
            ...
            return (
                <Comp
                    className={cn(
                        "stepper-controls flex justify-end gap-4",
                        className
                    )}
                    {...props}
                >
...
const StepperTitle = ({
    ...
    return (
        <Comp
            className={cn(
                "stepper-step-title font-normal text-[12px] sm:text-[14px]",
                className
            )}
            {...props}
        >
