export const testimonials = [
    ...
    },
    {
        ...
        text: "There’s a huge gap between property owners, renters, and agents — OPENDOOR bridges that gap with a clear, user-friendly system."
    },
    {
        ...
        text: "OPENDOOR introduces a level of professionalism and efficiency that is long overdue in Dhaka’s rental market."
    },
    {
        name: "Golam Rabbany",
        ...
        text: "OPENDOOR solves a real problem with an approach that's both technically thoughtful and socially relevant."
    },
];
